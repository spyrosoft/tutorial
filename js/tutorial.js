var Tutorial = function() {
	...
	return {
		addSection : function( new_section_identifier, new_title, new_intro ) {
			var identifier = new_section_identifier;
			var title = new_title;
			var intro = new_intro;
			...
			sections[ identifier ] = {
				...
				"addProblem" : function( problem_identifier, answer_or_answers ) {
					if ( typeof problem_identifier !== "string" ) {
						throw "The new problem identifier is not a string.";
					}
					if ( typeof answer_or_answers === "string"
					|| answer_or_answers instanceof Array ) {
						problems[ problem_identifier ] = answer_or_answers;
					} else {
						throw "The new problem is not a string or Array.";
					}
				},
		...
		getSection : function( section_identifier ) {
